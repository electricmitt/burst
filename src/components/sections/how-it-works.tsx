      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, index) => (
            <Card key={index} className="relative bg-card border-border hover:bg-accent transition-colors">
              ...
              <CardContent>
                <CardDescription className="text-card-foreground/70 text-center">
                  {step.description}
                </CardDescription>
              </CardContent>
            </Card>
